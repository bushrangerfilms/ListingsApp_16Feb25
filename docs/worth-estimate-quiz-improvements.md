...
2. 🟡 **Issue 2 (Comparable properties rendering)** — IN PROGRESS bundled with Issue 4 Part A + new-contact notification
3. 🔴 **Issue 3 (Unlock modal reframing)** — next up: conversion lift + "consent signature" reframe, require name
